...
define config.name = _("sporulation")
...
define config.main_menu_music = "/sounds/game draft again.mp3"
...
define config.save_directory = "sporulation-1719109396"
