...
image bb = im.FactorScale("battle/battleback.png", 1.0)
init python:
    #custom bar HP
...
label player1_skills:
    ...
    if p_skill == "Tboy Swag":
        ...
        $ target = "all"
        $ player1_mp -= 33
#    elif p_skill == "Sword Attack 4":
#        $ damage = player1_attack*5
#        $ target = "all"
#    elif p_skill == "Sword Attack 5":
#        $ damage = player1_attack * 10
#        $ target = "all"
#    elif p_skill == "Sword Attack 6":
#        $ damage = player1_attack*3
#        $ target = "all"
#    elif p_skill == "Sword Attack 7":
#        $ damage = player1_attack * 5 
    show screen battle_overlay_players
...
label player2_skills:
    ...
    if p_skill == "Rigorous Discourse":
        ...
        $ player2_mp -= 66
#    elif p_skill == "Dagger Attack 4":
#        $ damage = player2_attack*5
#        $ target = "all"
#    elif p_skill == "Dagger Attack 5":
#        $ damage = player2_attack * 10
#        $ target = "all"
#    elif p_skill == "Dagger Attack 6":
#        $ damage = player2_attack*3
#        $ target = "all"
#    elif p_skill == "Dagger Attack 7":
#        $ damage = player2_attack * 5
    show screen battle_overlay_players
    return
...
#    elif p_skill == "Bow Attack 4":
#        $ damage = player3_attack*5
#        $ target = "all"
#    elif p_skill == "Bow Attack 5":
#        $ damage = player3_attack * 10
#        $ target = "all"
#    elif p_skill == "Bow Attack 6":
#        $ damage = player3_attack*3
#        $ target = "all"
#    elif p_skill == "Bow Attack 7":
#        $ damage = player3_attack * 5
#    show screen battle_overlay_players
#    return    
...
screen parvez_skills:
    ...
    if player1_mp > 25:
        textbutton "Tboy Swag" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.8 action Return("Tboy Swag")  
    if player1_mp > 50:
        textbutton "Plantboy Dickslap" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.7 yalign 0.8 action Return("Plantboy Dickslap") 
    if player1_mp > 33:
        textbutton "Panic Attack" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.85 action Return("Panic Attack") 
#    textbutton "Sword Attack 4" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.7 yalign 0.85 action Return("Sword Attack 4")
#    textbutton "Sword Attack 5" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.9 action Return("Sword Attack 5")
#    textbutton "Sword Attack 6" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.7 yalign 0.9 action Return("Sword Attack 6")
#    textbutton "Sword Attack 7" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.95 action Return("Sword Attack 7")    
screen inanna_skills:
    add "battle/battlebox2.png" xalign 0.2 yalign .99
    if player2_mp > 33:
        textbutton "Rigorous Discourse" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.8 action Return("Rigorous Discourse")  
    if player2_mp > 45:
        textbutton "Mommy Smack" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.7 yalign 0.8 action Return("Mommy Smack") 
    if player2_mp > 66:
        textbutton "Righteous Smiting" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.85 action Return("Righteous Smiting") 
#    textbutton "Dagger Attack 4" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.7 yalign 0.85 action Return("Dagger Attack 4")
#    textbutton "Dagger Attack 5" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.9 action Return("Dagger Attack 5")
#    textbutton "Dagger Attack 6" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.7 yalign 0.9 action Return("Dagger Attack 6")
#    textbutton "Dagger Attack 7" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.95 action Return("Dagger Attack 7") 
...
#    textbutton "Bow Attack 4" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.7 yalign 0.85 action Return("Bow Attack 4")
#    textbutton "Bow Attack 5" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.9 action Return("Bow Attack 5")
#    textbutton "Bow Attack 6" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.7 yalign 0.9 action Return("Bow Attack 6")
#    textbutton "Bow Attack 7" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.1 yalign 0.95 action Return("Bow Attack 7") 
#screen terry_skills:
#    add "battle/battlebox2.png" xalign 0.2 yalign .99
...
screen battle_overlay_monsters:
    if marianne != "none":
        add marianne_image xalign 0.5 yalign 0.6
        bar:
            xalign .5
            yalign .5
            style "bar_hp"
        ...
        text "[marianne_hp]/[marianne_hp_max]" xalign 0.5 yalign 0.5
    if sarah != "none":
        add sarah_image xalign 0.2 yalign 0.6
        bar:
            xalign .2
            yalign .5
            style "bar_hp"
            ...
            range sarah_hp_max
        text "[sarah_hp]/[sarah_hp_max]" xalign 0.22 yalign 0.5
...
screen battle_message:
    ...
    if message == "player1_turn":
        text "What will [player1] do?" xalign 0.02 yalign 0.05
    elif message == "player2_turn":
        text "What will [player2] do?" xalign 0.02 yalign 0.05
#    elif message == "player3_turn":
#        text "What will [player3] do?" xalign 0.02 yalign 0.05
#    elif message == "player4_turn":
#        text "What will [player4] do?" xalign 0.02 yalign 0.05
    ...
    if message == "player_skill":
        ...
        text "[marianne] attacks! [m_target] took [m_damage] damage!" xalign 0.02 yalign 0.05
    elif message == "sarah_attack":
        text "[sarah] attacks! [m_target] took [m_damage] damage!" xalign 0.02 yalign 0.05
#    elif message == "chud_attack":
#        text "[chud] attacks! [m_target] took [m_damage] damage!" xalign 0.02 yalign 0.05
...
screen player_target: #returns monster player wants to attack
    if target == "all":
        ...
        if marianne != "none":
            textbutton "[marianne]" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.5 yalign 0.4 action Return("marianne") 
        if sarah != "none":
            textbutton "[sarah]" style "battlebutton" text_style "battlebutton_text" background "battle/transparent.png" xalign 0.2 yalign 0.4 action Return("sarah") 
#        if chud != "none":
